...
<h2 className='text-blackish text-[26px]  md:text-[30px] lg:text-[44px] font-bold leading-[1.3]'>{mainTitle}</h2>

<h3 className='text-[24px] text-gray-500'>starting at{" "} <b className='text-[20px] md:text-[24px] lg:text-[30px]'>{price}</b>.00</h3>
<div className='bg-[#FF8F9C] text-white text-[14px] p-2 px-4 rounded-lg inline-block cursor-pointer hover:bg-blackish'>Shop Now
